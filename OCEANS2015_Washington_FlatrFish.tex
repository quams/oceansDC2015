...
\begin{figure}[!t]
\begin{center}
	\subfloat[During transitions the dead reckoning is supported by tracking of asset strucutres like flowlines ]{\includegraphics[width=\columnwidth]{FF-NavigationOverview-1}}\\
	...
	\subfloat[During inspection the 3D reconstruction data (visual and sonar) is used to track the relative position to the structure ]{\includegraphics[width=\columnwidth]{FF-NavigationOverview-3}}\\
