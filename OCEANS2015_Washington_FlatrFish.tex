...
Based on \cite{albiez2010} and \cite{meinecke2013} using
ROCK\footnote{http://rock-robotics.org/} and component base development \cite{Joyeux2011}
principal shown in figure~\ref{fig:sw_arch}
...
\begin{figure}[!t]
\begin{center}
	\subfloat[During transitions the INS/DVL based localisation is supported by tracking of asset strucutres like flowlines ]{\includegraphics[width=\columnwidth]{FF-NavigationOverview-1}}\\
